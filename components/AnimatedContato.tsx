            ...
            <SlideInRight delay={0.3}>
              <HoverScale scale={1.02}>
                <div className="relative rounded-xl overflow-hidden shadow-lg min-h-[400px]">
                  <Image
                    src="/images/canva-12.jpg"
                    alt="MS Consultoria - Contato"
                    fill
                    className="object-cover"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/60 to-transparent" />
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    <h3 className="font-bold text-xl mb-2">MS Consultoria</h3>
          ...
          <FadeInUp>
            <div className="text-center">
              <h2 className="text-2xl font-bold text-white mb-4">
                Pronto para melhorar seus serviços de higienização?
              </h2>
              <motion.a
                href={whatsappUrl}
                target="_blank"
