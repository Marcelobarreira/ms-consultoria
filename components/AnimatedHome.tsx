        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <FadeInUp>
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">
              Pronto para elevar a qualidade dos seus serviços?
            </h2>
