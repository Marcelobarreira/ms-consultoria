...
export function AnimatedSobre() {
  const message = encodeURIComponent('Olá! Gostaria de mais informações sobre a MS Consultoria.')
    ...
    <>
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-20 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            Conheça a MS Consultoria e nossa equipe de especialistas em higienização hospitalar.
          </motion.p>
        </div>
      </section>
