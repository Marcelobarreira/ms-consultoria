...
export function ServiceCard({ id, title, shortDescription, icon }: ServiceCardProps) {
  return (
    <div className="group bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
      ...
      <Link
        href={`/servicos#${id}`}
        className="text-secondary text-sm font-medium hover:text-secondary-dark transition-colors inline-flex items-center gap-1"
      >
        Saiba mais
